  ...
  return (
    <div className={`bg-panel border-t border-gray-700/50 flex flex-col shrink-0 transition-all duration-200 ${collapsed ? 'h-8' : 'h-48'}`}>
      <button
        ...
        className="px-3 py-1.5 border-b border-gray-700/30 text-xs font-semibold text-gray-400 uppercase tracking-wider flex items-center gap-2 hover:bg-gray-700/20 transition-colors w-full text-left shrink-0"
      >
        <svg
